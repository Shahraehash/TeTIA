...
# Adapted from https://github.com/CompVis/latent-diffusion/blob/main/ldm/models/diffusion/ddpm.py under thr MIT license
...
from ldm.models.autoencoder1d import IdentityFirstStage, AutoencoderKL, VQModelInterface
